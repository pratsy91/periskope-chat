...
export default function TopBar({ username, showLogout, onToggleLogout, onLogout }: TopBarProps) {
  ...
  return (
    <header className="absolute top-0 left-0 w-full h-[56px] bg-white border-b border-[#e6e6e6] flex items-center justify-between px-4 z-20">
      ...
      <div className="flex items-center gap-2">
        <div className="hidden md:flex items-center gap-2">
          <div className="flex items-center gap-1 bg-white border border-[#e6e6e6] px-2 py-1 rounded cursor-pointer hover:bg-[#f7f8fa] text-[#384555]">
          ...
          <div className="flex items-center gap-1 bg-white border border-[#e6e6e6] px-2 py-1 rounded cursor-pointer text-[#384555]">
